...
export default class LoginScreen extends React.Component {
  ...
  render(){
      return(
        ...
        <View>
          <Text style={{textAlign: 'center', fontSize: 30}}>Lost</Text>
        </View>
        <View>
        <TextInput
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.appTitle}>
                    ...
                    <Text style={styles.appTitleText}>Lost</Text>
                    <Text style={styles.sideText}> Welcome Report As Many As Items As You Like</Text> 
                </View>
